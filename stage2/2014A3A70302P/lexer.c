...
#define _NO_DEBUG_ // this debug is used ony=ly for twin buffer ...
#ifndef _NO_DEBUG_
...
Token newToken( TOKEN t, char * lexeme ) {
	...
	switch(t) {
		case T_NUM:
			...
			break;
		case T_RNUM:
			token.lexeme._real = atof(lexeme);
			free(lexeme);
			break;
		case T_ID:
...
void printTokenInfo(Token token) {
	switch(token.token) {
		...
		case T_ASSIGN: printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_ASSIGN"); break;
		case T_FUNID:printf("%5d \033[035m%15s\033[0m \033[032m%s\033[0m\n",token.linenumber,"T_FUNID",token.lexeme._id); break;
		case T_ID:printf("%5d \033[035m%15s\033[0m \033[032m%s\033[0m\n",token.linenumber,"T_ID",token.lexeme._id); break;
		case T_NUM:printf("%5d \033[035m%15s\033[0m \033[034m%d\033[0m\n",token.linenumber,"T_NUM",token.lexeme._int); break;
		case T_RNUM:printf("%5d \033[035m%15s\033[0m \033[035m%.2f\033[0m\n",token.linenumber,"T_RNUM",token.lexeme._real); break;
		case T_STR: printf("%5d \033[035m%15s\033[0m \033[033m%s\033[0m\n",token.linenumber,"T_STR",token.lexeme._str); break;
		case T_END: printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_END"); break;
		case T_INT:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_INT"); break;
		case T_REAL:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_REAL"); break;
		case T_STRING:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_STRING"); break;
		case T_MATRIX:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_MATRIX"); break;
		case T_MAIN:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_MAIN"); break;
		case T_SQO:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_SQO"); break;
		case T_SQC:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_SQC"); break;
		case T_OP:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_OP");break;
		case T_CL:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_CL");break;
		case T_SEMICOLON:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_SEMICOLON");break;
		case T_COMMA:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_COMMA");break;
		case T_IF:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_IF");break;
		case T_ELSE:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_ELSE");break;
		case T_ENDIF:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_ENDIF");break;
		case T_READ:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_READ");break;
		case T_PRINT:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_PRINT");break;
		case T_FUNCTION:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_FUNCTION");break;
		case T_PLUS:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_PLUS");break;
		case T_MINUS:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_MINUS");break;
		case T_MUL:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_MUL");break;
		case T_DIV:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_DIV");break;
		case T_SIZE:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_SIZE");break;
		case T_AND:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_AND");break;
		case T_OR:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_OR");break;
		case T_NOT:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_NOT");break;
		case T_LT:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_LT");break;
		case T_LE:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_LE");break;
		case T_GT:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_GT");break;
		case T_GE:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_GE");break;
		case T_EQ:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_EQ");break;
		case T_NE: printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_NE");break;
		case T_EOF:printf("%5d \033[035m%15s\033[0m \n",token.linenumber,"T_EOF");break;
		default: printf("%5d \033[035m%15s\033[0m\n",token.linenumber,"Unknown");
